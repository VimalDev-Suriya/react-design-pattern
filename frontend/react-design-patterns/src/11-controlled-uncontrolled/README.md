...
- Here the React State is the *Source of truth*
...
- Hooks like useFormStatus and useActionState are the example of Uncontrolled - as untill the form gets submitted all the functionality are taken care by the 
